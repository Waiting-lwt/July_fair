...
_vue.default.mixin(_mixins.default);_vue.default.prototype.$myRequest = _api.myRequest;_vue.default.prototype.$uploadFile = _api.uploadFile;_vue.default.prototype.$chooseImage = _api.chooseImage;_vue.default.prototype.$formatDate = _formatDate.formatDate;_vue.default.prototype.$formatTime = _formatDate.formatTime;_vue.default.config.productionTip = false;var loading = function loading() {__webpack_require__.e(/*! require.ensure | components/loading/loading */ "components/loading/loading").then((function () {return resolve(__webpack_require__(/*! ./components/loading/loading.vue */ 139));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};_vue.default.component('loading', loading);_vue.default.component('springTabs', _springTabs.default);var Tabs = function Tabs() {__webpack_require__.e(/*! require.ensure | components/Tabs/Tabs */ "components/Tabs/Tabs").then((function () {return resolve(__webpack_require__(/*! ./components/Tabs/Tabs */ 146));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};
